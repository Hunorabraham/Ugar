...
namespace Ugar
{
    public class MenuManager
    {
        ...
        static public void LoadMainMenu(Game1 T)
        {
            ...
            Game1.ActiveButtons.Add(new Button(0.84f, 0.76f, 0.23f, 0.08f, Game1.TextureList["DebugTexture0"], () => { return 0; }, () => { return 0; }, () => { return 0; }));
            Game1.ActiveButtons.Add(new Button(0.86f, 0.88f, 0.23f, 0.08f, Game1.TextureList["QuitLabel"], () => { T.Exit(); return 0; }, () => { Game1.RenderList[1].Color = Color.White; return 0; }, () => { Game1.RenderList[1].Color = Color.Black; return 0; }));
        }
    }
}
