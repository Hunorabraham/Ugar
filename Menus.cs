...
namespace Ugar
{
    public class MenuManager
    {
        ...
        static public void LoadMainMenu(Game1 T)
        {
            ...
            Game1.ActiveButtons.Add(new Button(0.86f, 0.88f, 0.23f, 0.08f, () => { T.Exit(); return 0; }, () => { return 0; }, () => { return 0; }));
            Game1.ActiveButtons.Add(new Button(0.86f, 0.80f, 0.23f, 0.08f, () => { return 0; }, () => { return 0; }, () => { return 0; }, true));
